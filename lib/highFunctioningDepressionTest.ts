...
export const depressionResults: DepressionResult[] = [
  ...
  },
  {
    ...
    suggestion:
      "지금은 분석보다 연결이 먼저입니다. 오늘 안에 신뢰할 수 있는 사람에게 상태를 알리고, 필요하면 한국생명의전화 1588-9191 또는 119/응급실처럼 즉시 도움을 받을 수 있는 경로를 이용하세요.",
    routine: ["혼자 있지 않을 시간 확보하기", "가까운 사람에게 '지금 혼자 버티기 어렵다'고 보내기", "위기 연락처 1588-9191, 119, 지역 정신건강복지센터 저장하기"],
